/*
 ...
 Author      : Aaron Ma
 Description : Obstacle Avoidance discontinue
 ============================================================================
*/
			...
			if ( data.m_greyscale_image_left[d] )
			{
				...
				else if(frame_num > 0)
				{
					...
					if(left_disc > right_disc)
					{
						...
						{
							if(turn_prev > 0) l_turn = (1 + (left_disc - right_disc)/(left_disc + right_disc))*turn_prev;
							else l_turn = TURN;
						}
					...
					else if(right_disc > left_disc)
					{
						...
						{
							if(turn_prev < 0) l_turn = (1 + (right_disc - left_disc)/(right_disc + left_disc))*turn_prev;
					...
					if(up_disc > down_disc)
					{
						...
						{
							if(alt_prev < 0) l_alt = (1 + (up_disc - down_disc)/(up_disc + down_disc))*alt_prev;
							else l_alt = -1.0*ALT;
						}
					...
					else if(down_disc > up_disc)
					{
						...
						{
							if(alt_prev > 0) l_alt = (1 + (down_disc - up_disc)/(down_disc + up_disc))*alt_prev;
							else l_alt = ALT;
						}
			...
			if ( data.m_greyscale_image_right[d] )
			{
				...
				else if(frame_num > 0)
				{
					...
					if(left_disc > right_disc)
					{
						...
						{
							if(turn_prev > 0) r_turn = (1 + (left_disc - right_disc)/(left_disc + right_disc))*turn_prev;
							else r_turn = TURN;
						}
					...
					else if(right_disc > left_disc)
					{
						...
						{
							if(turn_prev < 0) r_turn = (1 + (right_disc - left_disc)/(right_disc + left_disc))*turn_prev;
					...
					if(up_disc > down_disc)
					{
						...
						{
							if(alt_prev < 0) r_alt = (1 + (up_disc - down_disc)/(up_disc + down_disc))*alt_prev;
							else r_alt = -1.0*ALT;
						}
					...
					else if(down_disc > up_disc)
					{
						...
						{
							if(alt_prev > 0) r_alt = (1 + (down_disc - up_disc)/(down_disc + up_disc))*alt_prev;
							else r_alt = ALT;
						}
